...
-   List each variable and the level of measurement. Note if there are
    ...
    -   frst2 - ordinal, no issues noted +vfrst3 - ordinal, no issues
        noted
...
``` r
# I compared the variables side by side, they look are the same in each column, no issues noted
```
...
-   What does it mean if a z-score is positive or negative?
    ...
    -   positive: The score above the mean.
